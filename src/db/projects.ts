...
export type projectsTypes = {
  ...
  year: string;
  role: string;
  context: "Projeto de Trabalho" | "Freelance" | "Projeto de Estudo" | "Hackathon";
  category: string;
...
const projects: projectsTypes[] = [
  {
    ...
    description:
      "Plataforma de aplicação de formulários digitais",
    techs: ["React", "Vite"],
    year: "2024",
    role: "Front-End Developer",
    context: "Projeto de Trabalho",
    ...
    name: "Pirate's Punch",
    description:
      "E-commerce de bebidas com tematica pirata",
