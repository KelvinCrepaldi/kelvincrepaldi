...
export default function Timeline() {
  return (
    <section className="w-full bg-primary flex flex-col px-10 items-center justify-center py-40 font-mono">
      <div>
        <h1 className="text-3xl text-secondary mb-10">Time Line</h1>
        <div className="relative border-l border-background pl-6 ml-4  max-w-[800px] w-full text-secondary">
          {experiences.map((exp, index) => (
            <div key={index} className="mb-20 relative">
              {/* Ponto na linha */}
              <div className="absolute -left-[13px] top-2 w-2 h-2 bg-green-700  rounded-full"></div>
