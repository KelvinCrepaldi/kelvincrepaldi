...
export default function ProjectCard({project}: {project: projectsTypes}) {
  return (
    <Link to={`/project/${project.id}`} className="w-[300px] flex flex-col items-center justify-center group">
